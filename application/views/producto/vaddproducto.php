...
<div class="box box-primary">
  <div class="box-body">
	<div class="col-sm-4">
	  <div class="box box-primary">
	    <form method="post" action="<?php echo base_url();?>cproducto/upProducto" method="POST" enctype="multipart/form-data">
	      <table class="table table-bordered table-striped" style="width: 332	px">
			<thead>
			  <tr>
		        ...
		        <th style="background-color: #006699; color: white;"><input type="text" name="txtNombre" value="" style="width: 220px;background-color: white; color: black;" ></th>
			  </tr>
              <tr>
		        <th style="width: 25px;background-color: #006699; color: white;">Descripcion</th>
		        <th style="background-color: #006699; color: white;"><input type="text" name="txtDesc" value="" style="width: 220px;background-color: white; color: black;" ></th>
			  </tr>
              <tr>
		        <th style="width: 25px;background-color: #006699; color: white;">Peso (Kg)</th>
		        <th style="background-color: #006699; color: white;"><input type="text" name="txtPeso" value="" style="width: 220px;background-color: white; color: black;" ></th>
			  </tr>
              <tr>
		        <th style="width: 25px;background-color: #006699; color: white;">USD</th>
		        <th style="background-color: #006699; color: white;"><input type="text" name="txtUSD" value="" style="width: 220px;background-color: white; color: black;" ></th>
			  </tr>
              <tr>
		        <th style="width: 25px;background-color: #006699; color: white;">Categoria</th>
		        <th style="background-color: #006699; color: white;"><input type="text" name="txtCatego" value="" style="width: 220px;background-color: white; color: black;" ></th>
			  </tr>
			  <tr>
